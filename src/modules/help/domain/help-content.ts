...
export const helpModules: HelpModule[] = [
  ...
  },
  {
    ...
    description: "Aqui você vê as publicações que chegaram para o escritório, confere o processo e decide o que precisa ser feito.",
    steps: [
      "Confira as publicações novas e abra cada uma para ler o texto completo.",
      "Em Para revisão, confira os resultados encontrados sem identificação suficiente e confirme somente os que pertencem ao escritório.",
      "Quando houver prazo, confira a comunicação e confirme a data antes de criar o prazo definitivo.",
      "Depois de definir a providência, marque a publicação como tratada.",
    ],
    tips: ["Resultados para revisão não são prazos nem publicações confirmadas.", "Uma comunicação confirmada pode ser vinculada ao processo pelo número CNJ já cadastrado."],
  },
  {
    key: "prazos",
  ...
  },
  {
    ...
    steps: [
      "O proprietário cria o auxiliar com nome, e-mail, celular, função, OAB e senha provisória.",
      "No primeiro acesso, o auxiliar precisa trocar a senha provisória.",
      "Confira os dados antes de criar: depois, somente o e-mail e o celular podem ser alterados na Equipe.",
      "Se mudar o e-mail do auxiliar, ele precisará entrar novamente e confirmar o novo endereço. Ao remover um integrante, o histórico permanece.",
    ],
